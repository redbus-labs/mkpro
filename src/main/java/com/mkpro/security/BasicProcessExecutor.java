...
/**
 * BasicProcessExecutor provides a hardened process execution layer implementing ICommandExecutor.
 * It handles:
 ...
 */
public class BasicProcessExecutor implements ICommandExecutor {
    ...
    public BasicProcessExecutor(int timeoutSeconds, int maxOutputBytes) {

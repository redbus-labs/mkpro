...
/**
 * Highly optimized, compact MapDB serializer for the Entity record.
 */
public class EntitySerializer implements Serializer<Entity> {

    @Override
    public void serialize(DataOutput2 out, Entity value) throws IOException {
    ...
    @Override
    public Entity deserialize(DataInput2 in, int available) throws IOException {
        String id = in.readUTF();
        String name = in.readUTF();
        EntityType type = EntityType.values()[in.readByte()];
        ...
        return new Entity(id, name, type, metadata);
    }
}
